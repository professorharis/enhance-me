  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white text-gray-900 font-sans">
      ...
      <div className="md:hidden h-14 bg-white border-b border-gray-200 flex items-center justify-between px-4 sticky top-0 z-50">
        ...
        <span className="font-bold text-gray-900 text-sm">About Us</span>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-bold text-sm sm:text-base md:text-lg">Free & Accessible</h4>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-bold text-sm sm:text-base md:text-lg">Privacy First</h4>
                  <p className="text-gray-600 text-xs sm:text-sm md:text-base">All processing happens locally</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-bold text-sm sm:text-base md:text-lg">AI Powered</h4>
                  <p className="text-gray-600 text-xs sm:text-sm md:text-base">Advanced algorithms for perfect results</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl sm:rounded-2xl md:rounded-3xl p-6 sm:p-8 text-white mt-6 sm:mt-8 lg:mt-0">
            <div className="space-y-4 sm:space-y-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-white/20 rounded-lg sm:rounded-xl md:rounded-2xl flex items-center justify-center">
                <Heart size={20} className="sm:size-6 md:size-8" />
              </div>
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold">Built with ❤️</h3>
      ...
      <div className="bg-gray-50 py-8 sm:py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-16">
          <div className="text-center mb-6 sm:mb-8 md:mb-12">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4">Our Technology</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 md:mb-4">Fast Processing</h3>
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 md:mb-4">Privacy Focused</h3>
              <p className="text-gray-600 text-xs sm:text-sm md:text-base">
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 md:mb-4">Accessible Everywhere</h3>
              <p className="text-gray-600 text-xs sm:text-sm md:text-base">
